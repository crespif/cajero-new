  ...
  try {
    ...
    return (
      <>
        ...
        <Link href="/" className="flex items-center w-36 justify-center gap-2 self-start rounded-lg bg-blue-500 my-2 py-1 px-3 text-sm font-medium text-white transition-colors hover:bg-blue-400 md:text-base m-auto">
          <span>Volver</span>
        </Link>
      </>
    )
